...
namespace Day5.Controllers
{
    public class EventsController : Controller
    {
        ...
        // GET: Events/SearchBar
        public IActionResult SearchBar()
        {
            return View();
        }

        // GET: Events/SearchResults
        ...
        public async Task<IActionResult> Create([Bind("Id,Title")] Events events)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title")] Events events)
        {
            if (id != events.Id)
                return NotFound();
