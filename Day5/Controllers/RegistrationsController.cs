...
namespace Day5.Controllers
{
    public class RegistrationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id,Date")] Registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id,Date")] Registration registration)
        {
